...
export default function Footer() {
  ...
  // 높이 자동 조절 (CSS transition 이용)
  useEffect(() => {
    if (footerHideRef.current) {
      footerHideRef.current.style.maxHeight = open
        ? `${footerHideRef.current.scrollHeight}px`
        : "0px";
    }
  }, [open]);
